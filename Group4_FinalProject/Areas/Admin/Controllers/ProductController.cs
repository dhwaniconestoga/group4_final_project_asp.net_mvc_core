...
namespace Group4_FinalProject.Areas.Admin.Controllers
{
    ...
    {
        private IElectronicsStoreUnitOfWork data { get; set; }
        private readonly IWebHostEnvironment _hostEnvironment;

        public ProductController(ElectronicsStoreContext ctx, IWebHostEnvironment hostEnvironment)
        {
            data = new ElectronicsStoreUnitOfWork(ctx);
